            ...
            <div class="fixed top-0 right-0 px-6 py-4">
                ...
                @else
                    <a href="{{ route('auth.vkontakte') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">{{ __('Sign in with VK') }}</a>
                    <a href="{{ route('auth.yandex') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">{{ __('Sign in with Yandex') }}</a>
